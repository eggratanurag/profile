  ...
  const navFunction = new IntersectionObserver(function (
    ...
    entries.forEach(function (entry) {
      if (!entry.isIntersecting) {
        ...
        entry.target.classList[0] === "section1"? liRef1.current.classList.add("present"):liRef1.current.classList.remove("present")
        entry.target.classList[0] === "section2"? liRef2.current.classList.add("present"):liRef2.current.classList.remove("present") 
        entry.target.classList[0] === "section3"? liRef3.current.classList.add("present"):liRef3.current.classList.remove("present")
        entry.target.classList[0] === "section4"? liRef4.current.classList.add("present"):liRef4.current.classList.remove("present") 
        entry.target.classList[0] === "section5"? liRef5.current.classList.add("present"):liRef5.current.classList.remove("present") 
...
//    
  ...
  <p className='curls'>about</p>
      ...
      <div className='page page1'>
        <h1>Hi!</h1>
        <h2>My name is <span style={{color:"#697C37"}}>Anurag</span> and I'm a Web Developer </h2>
        <p>I am passionate about Front-End Development. I also like to create Full-Stack Applications. </p>
        <p style={{color:"#95956E"}}>My interest falls more on playing with CSS and bringing out something worthwhile. Most of my time is spent on creating responsive web apps. I like to use modern front-end libraries to fasten up the process while keeping in mind that the build stays authentic by giving slight tweaks. Interested in the entire front-end spectrum and working on ambitious projects with positive people.</p>
      </div>
      </div>
    </section>
    ...
    <div className='flex'>
      <div className='page2 page '>
        <h1>I've</h1>
        <h2> been learning full-stack web development for more than year</h2>
        <p>Ive created apps using <span style={{color:"#697C37"}}> vanilla javascript, jquery, express</span>. At this time I'm making projects using React.js
        As I can develop full-stack apps I've also used <span style={{color:"#697C37"}}>Mongodb, Node.js</span> in projects to create backend.
        .I also use modern CSS frameworks such as <span style={{color:"#697C37"}}>tailwind, bootstrap, chakraUI</span>. Previously, I've worked as a graphic designer in a company and also as a freelancer.
        .I have no experience of working in a company or in a team, I am a fresher but with skills
        </p>
      ...
      <div className='page4 page'>
        ...
        <div className='iconsDiv'>
         ...
         <form ref={form} onSubmit={sendEmail}>
          ...
          <p style={{marginTop:"0"}}>I’m looking for job and also interested in freelance opportunities especially ambitious or large projects. However, if you have other request or question, don’t hesitate to use the form.</p>
          ...
          <textarea type="text" rows="4" placeholder='type a message' name="message" onChange={e => setMessage(e.target.value)}/>
          <button type='submit' value="send" disabled={!name || !email || !message}><h3>{text}</h3></button>
         </form>
       </div>
  ...
  <div className='navDiv'>
    ...
    <ul>
      <a href='#section1' ref={liRef1} className="li1 li"><InfoTwoToneIcon /></a>
      <a href='#section2' ref={liRef2} className="li2 li"><LightbulbTwoToneIcon /></a>
